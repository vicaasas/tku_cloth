      ...
      <template 
        ...
        <span v-else-if="rows.column.field === 'edit'" >
          <span v-if="rows.row.vgtSelected==true">
            <button type="button" class="btn btn-primary" :id="rows.row.student_id"  data-target="#editModal" :disabled="false" :data-student="rows.row.student_id" @click="open_model">編輯</button>
          </span>
          <span v-else>
            <button type="button" class="btn btn-primary" :id="rows.row.student_id" data-toggle="modal" data-target="#editModal" :disabled="true" :data-student="rows.row.student_id">編輯</button>
          </span>
        </span>
      </template>
