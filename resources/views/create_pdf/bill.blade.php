                    ...
                    <th>
                        <ol style="line-height:30px;">
                            ...
                            <li style="margin-top:10px">
                                ...
                                {{ date("h", strtotime($cloth_pick_time->start_time)) }} 時至 {{ date("h", strtotime($cloth_pick_time->end_time)) }}，持本繳費單繳款人收執聯至覺生紀念圖書館大門前領取學士服。<br>
                            </li>
                        </ol>
                    </th>
                </tr>
                            ...
                            <th>
                                <ol style="line-height:30px;">
                                    ...
                                    <li style="margin-top:10px">
                                        ...
                                        至
                                        {{ date("Y/m/d", strtotime($cloth_pick_time->end_time)) }}
                                        {{ date("h", strtotime($cloth_pick_time->start_time)) }} 時至 {{ date("h", strtotime($cloth_pick_time->end_time)) }} 時，持本繳費單繳款人收執聯至覺生紀念圖書館大門前領取學士服。<br>
                                    </li>
                                </ol>
                            </th>
                        </tr>
