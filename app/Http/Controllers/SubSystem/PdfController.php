...
class PdfController extends Controller
{
    ...
    public function not_return(){
        ...
        $not_return_pdf=View::make('sub_system.create_pdf.pdf_order_table',[
    ...
    public function is_return(){
        ...
        $is_return_pdf=View::make('sub_system.create_pdf.pdf_order_table',[
            'degree'=>request()->degree,
            'pdf_name'=>"已歸還名冊",
    ...
    public function receipt_bail(){
        ...
        $is_return_pdf=View::make('sub_system.create_pdf.receipt_bail',[
    ...
    public function student_bill_pdf($student_id,$order_id){
        ...
        $bill_pdf=View::make('sub_system.create_pdf.bill',[
            'student_data'=>$student_data,
    ...
    public function bill_proof(){
        ...
        $this_year = explode('-', $return_due_date->end_time);
        $year = $this_year[0] - 1911;
        $is_return_pdf=View::make('sub_system.create_pdf.receipt_proof',[
            'student_data'=>$student_data,
            'year'=>(date("Y") - 1911),
            'month'=>date("m"),
            'day'=>date("d"),
    ...
    {
        $year=substr(env('DB_DATABASE_SECOND'),0,3);
