...
class ReportController extends Controller
{
    ...
    public function get_degree($m_or_b){
        ...
        $table=View::make('sub_system.partial_view.class_order_table',[
    ...
    public function total(){
        ...
        //         ->get();
        return view('sub_system.admin.report.total',self::get_degree('學士'));
    }
    ...
    public function class_order($class_name){
        return view('sub_system.admin.report.self_class_order',
        [
            "class_name" => $class_name,
    ...
    public function all_student_order(){
        return view('sub_system.admin.report.student_list',
        [
